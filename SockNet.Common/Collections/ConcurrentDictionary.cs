...
using ArenaNet.SockNet.Common.Threading;
...
namespace ArenaNet.SockNet.Common.Collections
{
    ...
    {
        public delegate TValue AddValueFactoryDelegate(TKey key);
        public delegate TValue UpdateValueFactoryDelegate(TKey key, TValue previousValue);
        ...
        public TValue GetOrAdd(TKey key, AddValueFactoryDelegate valueFactory)
        {
            if (key == null) throw new ArgumentNullException("key");
        ...
        public TValue AddOrUpdate(TKey key, AddValueFactoryDelegate addValueFactory, UpdateValueFactoryDelegate updateValueFactory)
        {
            if (key == null) throw new ArgumentNullException("key");
        ...
        /// <returns>The new value for the key.  This will be either be the result of addValueFactory (if the key was 
        /// absent) or the result of updateValueFactory (if the key was present).</returns>
        public TValue AddOrUpdate(TKey key, TValue addValue, UpdateValueFactoryDelegate updateValueFactory)
        {
            if (key == null) throw new ArgumentNullException("key");
            if (updateValueFactory == null) throw new ArgumentNullException("updateValueFactory");
            TValue newValue, resultingValue;
    ...
    internal static class HashHelpers
    {
        ...
        public static int ExpandPrime(int oldSize)
        {
            ...
            {
                if (MaxPrimeArrayLength != GetPrime(MaxPrimeArrayLength)) throw new InvalidOperationException("Invalid MaxPrimeArrayLength");
